...
|---|---|---|---|
| Done | CB | Publish Design Taxonomy | docs/DESIGN_TAXONOMY.md |
...
| In Progress | Morgan | a11y/test plan draft | ETA: tonight |
| In Progress | Mike | Technical guardrails + architecture notes | ETA: tonight |
